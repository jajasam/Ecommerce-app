                ...
                <div className="products">
                    <div id="ZX9-speaker">
                        ...
                        <div>
                            ...
                            <button className="btn"><Link to="/product/6" state={{productId: 6}}>See product</Link></button>
                        </div>
                    </div>
                    <div 
                        id="ZX7-speaker" 
                        ...
                        <div>
                            <h3>ZX7 speaker</h3>
                            <button className="btn secondary-btn"><Link to="/product/5" state={{productId: 5}}>See product</Link></button>
                        </div>
                    </div>
                    <div id="YX1-earphones">
                        ...
                        <div className="product-infos">
                            <div>
                            <h3>YX1 earphones</h3>
                            <button className="btn secondary-btn"><Link to="/product/1" state={{productId: 1}}>See product</Link></button>
                        </div>
                    </div>
                </div>
            </div>
